...
export async function getMarketPrice({ networkID, provider }: IBaseAsyncThunk) {
  const fan_dai_address = fan_dai.getAddressForReserve(networkID);
  const pairContract = new ethers.Contract(fan_dai_address || "", PairContractABI, provider) as PairContract;
