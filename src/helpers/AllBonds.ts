...
import { ReactComponent as LionDaiImg } from "src/assets/tokens/LION-DAI.svg";
import { ReactComponent as FraxImg } from "src/assets/tokens/FRAX.svg";
import { ReactComponent as LionFraxImg } from "src/assets/tokens/LION-FRAX.svg";
import { ReactComponent as LionLusdImg } from "src/assets/tokens/LION-LUSD.svg";
import { ReactComponent as LionEthImg } from "src/assets/tokens/LION-WETH.svg";
import { ReactComponent as wETHImg } from "src/assets/tokens/wETH.svg";
import { ReactComponent as LusdImg } from "src/assets/tokens/LUSD.svg";
import { ReactComponent as CvxImg } from "src/assets/tokens/CVX.svg";

import { abi as FraxLionBondContract } from "src/abi/bonds/LionFraxContract.json";
import { abi as BondLionDaiContract } from "src/abi/bonds/LionDaiContract.json";
import { abi as BondLionLusdContract } from "src/abi/bonds/LionLusdContract.json";
import { abi as BondLionEthContract } from "src/abi/bonds/LionEthContract.json";

import { abi as DaiBondContract } from "src/abi/bonds/DaiContract.json";
import { abi as ReserveLionLusdContract } from "src/abi/reserves/LionLusd.json";
import { abi as ReserveLionDaiContract } from "src/abi/reserves/LionDai.json";
import { abi as ReserveLionFraxContract } from "src/abi/reserves/LionFrax.json";
import { abi as ReserveLionEthContract } from "src/abi/reserves/LionEth.json";
...
export const lion_dai = new LPBond({
  name: "lion_dai_lp",
  displayName: "LION-DAI LP",
  bondToken: "DAI",
  payoutToken: "LION",
  bondIconSvg: LionDaiImg,
  bondContractABI: BondLionDaiContract,
  reserveContract: ReserveLionDaiContract,
  isBondable: {
    [NetworkID.Mainnet]: false,
    [NetworkID.Testnet]: true,
    [NetworkID.Arbitrum]: false,
...
export const lion_frax = new LPBond({
  name: "lion_frax_lp",
  displayName: "LION-FRAX LP",
  bondToken: "FRAX",
  payoutToken: "LION",
  bondIconSvg: LionFraxImg,
  bondContractABI: FraxLionBondContract,
  reserveContract: ReserveLionFraxContract,
  isBondable: {
    [NetworkID.Mainnet]: true,
    [NetworkID.Testnet]: true,
    [NetworkID.Arbitrum]: false,
...
export const lion_lusd = new LPBond({
  name: "lion_lusd_lp",
  displayName: "LION-LUSD LP",
  bondToken: "LUSD",
  payoutToken: "LION",
  bondIconSvg: LionLusdImg,
  bondContractABI: BondLionLusdContract,
  reserveContract: ReserveLionLusdContract,
  isBondable: {
    [NetworkID.Mainnet]: false,
    [NetworkID.Testnet]: false,
    [NetworkID.Arbitrum]: false,
  ...
  networkAddrs: {
    ...
    [NetworkID.Testnet]: {
      // NOTE (appleseed-lusd): using lion-dai rinkeby contracts
      bondAddress: "0xcF449dA417cC36009a1C6FbA78918c31594B9377",
      reserveAddress: "0x8D5a22Fb6A1840da602E56D1a260E56770e0bCE2",
    },
  },
...
export const lion_weth = new CustomBond({
  name: "lion_weth_lp",
  displayName: "LION-WETH LP",
  bondToken: "WETH",
  payoutToken: "LION",
  bondIconSvg: LionEthImg,
  bondContractABI: BondLionEthContract,
  reserveContract: ReserveLionEthContract,
  isBondable: {
    [NetworkID.Mainnet]: true,
    [NetworkID.Testnet]: true,
    [NetworkID.Arbitrum]: false,
  ...
  networkAddrs: {
    ...
    [NetworkID.Testnet]: {
      // NOTE (unbanksy): using lion-dai rinkeby contracts
      bondAddress: "0xcF449dA417cC36009a1C6FbA78918c31594B9377",
      reserveAddress: "0x8D5a22Fb6A1840da602E56D1a260E56770e0bCE2",
    },
  },
  ...
  customTreasuryBalanceFunc: async function (this: CustomBond, networkID, provider) {
    if (networkID === NetworkID.Mainnet) {
      ...
      // NOTE (appleseed): using LION-DAI on rinkeby
      const token = this.getContractForReserve(networkID, provider);
      const tokenAddress = this.getAddressForReserve(networkID);
      const bondCalculator = getBondCalculator(networkID, provider);
      const tokenAmount = await token.balanceOf(addresses[networkID].TREASURY_ADDRESS);
...
export const allBonds = [dai, frax, eth, cvx, lion_dai, lion_frax, lusd, lion_lusd, lion_weth];
