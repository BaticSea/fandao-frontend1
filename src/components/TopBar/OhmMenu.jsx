...
function FanMenu() {
  ...
  const SFAN_ADDRESS = addresses[networkId] && addresses[networkId].SFAN_ADDRESS;
  const FAN_ADDRESS = addresses[networkId] && addresses[networkId].FAN_ADDRESS;
              ...
              <Paper className="fan-menu" elevation={1}>
                <Box component="div" className="buy-tokens">
                  ...
                  <Link component={NavLink} to="/wrap" style={{ textDecoration: "none" }}>
                    <Button size="large" variant="contained" color="secondary" fullWidth>
                      <Typography align="left">Wrap sFAN</Typography>
                    </Button>
                  </Link>
                </Box>
