...
import gLionImage from "src/assets/tokens/glion.png";
...
export default function ExternalStakePool() {
  ...
  return (
    <Zoom in={true}>
      <Paper className={`lion-card secondary ${isSmallScreen && "mobile"}`}>
            ...
            <TableContainer className="stake-table">
              <Table>
                <TableBody>
                  <TableRow>
                    <TableCell>
                      <Box className="lion-pairs">
                        <MultiLogo images={[gLionImage, avaxImage]} avatarStyleOverride={avatarStyle} />
                        <Box width="16px" />
                        <Typography>gLION-AVAX</Typography>
                      </Box>
                    </TableCell>
            ...
            <div className="stake-pool">
              <div className={`pool-card-top-row ${isMobileScreen && "small"}`}>
                <Box className="lion-pairs">
                  <MultiLogo images={[gLionImage, avaxImage]} avatarStyleOverride={avatarStyle} />
                  <Box width="16px" />
                  <Typography gutterBottom={false}>gLION-AVAX</Typography>
                </Box>
              </div>
