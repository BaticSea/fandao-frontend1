...
function ZapInfo({ tokens, address }) {
  ...
  return (
    <>
      <Paper className="lion-card" id="olyzaps-info">
        <Grid container direction="row" wrap spacing={4}>
          ...
          <Grid item sm={12} md={4} classes={{ root: classes.infoBox, item: classes.infoBoxItem }}>
            ...
            <Box classes={{ root: classes.infoBody }}>
              ...
              <Typography align="left" variant="body2" className="oly-info-body">
                <Trans>OlyZap reduces complexity, saves you time and keeps you here on Lion.</Trans>
              </Typography>
            </Box>
          </Grid>
          <Grid item sm={12} md={4} classes={{ root: classes.infoBox, item: classes.infoBoxItem }}>
            ...
            <Box classes={{ root: classes.infoBody }}>
              ...
              <Typography align="left" variant="body2" className="oly-info-body">
                <Trans>
                  Staking is the primary value accrual strategy of Lion. When you stake, you lock LION and receive an
                  equal amount of sLION.
                </Trans>
              </Typography>
            </Box>
          </Grid>
        ...
        <Box className="button-box">
          <Button
            variant="outlined"
            color="secondary"
            href="https://docs.liondao.finance/main/using-the-website/olyzaps"
            target="_blank"
