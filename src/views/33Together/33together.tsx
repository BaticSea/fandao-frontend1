...
const PoolTogether = () => {
  ...
  const [infoTooltipMessage, setInfoTooltipMessage] = useState<Array<string>>([
    "Deposit sLION to win! Once deposited, you will receive a corresponding amount of 33T and be entered to win until your sLION is withdrawn.",
  ]);
  ...
  return (
    <div id="pool-together-view">
      ...
      <PoolInfo
        ...
        slionBalance={trimOdds(parseFloat(slionBalance))}
