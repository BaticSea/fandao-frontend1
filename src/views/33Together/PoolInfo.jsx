      ...
      <Paper className="lion-card">
          ...
          <>
            <Box display="flex" flexDirection="column" className="user-pool-data">
              ...
              <div className="data-row">
                ...
                <Typography>{props.isAccountLoading ? <Skeleton width={100} /> : props.slionBalance} sLION</Typography>
              </div>
            </Box>
        ...
        <Box display="flex" flexDirection="column" className="pool-data">
          ...
          <div className="data-row">
            ...
            <Typography>
              {props.graphLoading ? <Skeleton width={100} /> : props.totalDeposits.toLocaleString()} sLION
            </Typography>
          </div>
          <div className="data-row">
            <Typography>
            ...
            <Typography>
              {props.graphLoading ? <Skeleton width={100} /> : props.totalSponsorship.toLocaleString()} sLION
            </Typography>
          </div>
          <div className="data-row">
            <Typography>
        ...
        <div className="data-row-centered">
          ...
          <div className="marginedBtn">
            <Button variant="outlined" color="secondary" href={poolTogetherUILinks(networkId)[1]} target="_blank">
              <Typography variant="body1">
                <Trans>sLION Pool Details</Trans>&nbsp;
              </Typography>
              <SvgIcon component={ArrowUp} color="primary" />
            </Button>
          </div>
